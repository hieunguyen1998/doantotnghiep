...
<ul id="main-nav">
  ...
  <li> 
  <a href="hoadon.php" class="nav-top-item no-submenu"> 
  ...
  <li> <a href="#" class="nav-top-item" id="monan"> Tin tức </a>
    <ul>
      <li><a href="baiviet.php" title="monan">Danh sách tin tức</a></li>
      <li><a href="thembaiviet.php" title="monan">Thêm tin tức</a></li>
    </ul>
  </li>
